...
Download the executable for your platform from [here](https://github.com/aminya/setup-cpp/releases/tag/v0.5.0), and run it with the available options.
...
Download the `setup_cpp.js` file form [here](https://github.com/aminya/setup-cpp/releases/download/v0.5.0/setup_cpp.js), and run it with the available options.
