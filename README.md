...
[![CI](https://github.com/aminya/setup-cpp/actions/workflows/CI.yml/badge.svg?event=push)](https://github.com/aminya/setup-cpp/actions/workflows/CI.yml)
...
| build system    | cmake, ninja, meson, make, autoreconf, task, bazel                                                          |
...
Download the executable for your platform from [here](https://github.com/aminya/setup-cpp/releases/tag/v1.10.0), and run it with the available options. You can also automate downloading using `curl`, or other similar tools.

```shell
# windows x64
curl -o ./setup-cpp.exe -LJ "https://github.com/aminya/setup-cpp/releases/download/v1.10.0/setup-cpp-x64-windows.exe"
# linux x64
curl -o ./setup-cpp -LJ "https://github.com/aminya/setup-cpp/releases/download/v1.10.0/setup-cpp-x64-linux"
# linux arm64
curl -o ./setup-cpp -LJ "https://github.com/aminya/setup-cpp/releases/download/v1.10.0/setup-cpp-arm64-linux"
# macos arm64
curl -o ./setup-cpp -LJ "https://github.com/aminya/setup-cpp/releases/download/v1.10.0/setup-cpp-arm64-macos"
# macos x64
curl -o ./setup-cpp -LJ "https://github.com/aminya/setup-cpp/releases/download/v1.10.0/setup-cpp-x64-macos"
```
...
- Base image with pinned setup-cpp version: `aminya/setup-cpp-ubuntu:26.04-v1.10.0`
- Compiler image with pinned setup-cpp version: `aminya/setup-cpp-ubuntu-llvm:26.04-v1.10.0`
...
RUN apt-get update -qq && \
    ...
    # install setup-cpp
    npm install -g setup-cpp@v1.10.0 && \
