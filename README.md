...
Download the executable for your platform from [here](https://github.com/aminya/setup-cpp/releases/tag/v0.5.6), and run it with the available options.

An example that installs llvm, cmake, ninja, ccache, and vcpkg:

```ps1
# windows example (open shell as admin)
curl -LJO "https://github.com/aminya/setup-cpp/releases/download/v0.5.6/setup_cpp_windows.exe"
...
```ps1
# linux example
wget "https://github.com/aminya/setup-cpp/releases/download/v0.5.6/setup_cpp_linux"
...
```ps1
# mac example
wget "https://github.com/aminya/setup-cpp/releases/download/v0.5.6/setup_cpp_mac"
...
Download the `setup_cpp.js` file form [here](https://github.com/aminya/setup-cpp/releases/download/v0.5.6/setup_cpp.js), and run it with the available options.
...
```ps1
# open shell as admin
curl -LJO "https://github.com/aminya/setup-cpp/releases/download/v0.5.6/setup_cpp.js"
...
```ps1
wget "https://github.com/aminya/setup-cpp/releases/download/v0.5.6/setup_cpp.js"
...
RUN wget --no-verbose "https://github.com/aminya/setup-cpp/releases/download/v0.5.6/setup_cpp_linux"
