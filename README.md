...
Download the executable for your platform from [here](https://github.com/aminya/setup-cpp/releases/tag/v0.10.0), and run it with the available options.
...
```ps1
# linux example
wget "https://github.com/aminya/setup-cpp/releases/download/v0.10.0/setup_cpp_linux"
...
```ps1
# mac example
wget "https://github.com/aminya/setup-cpp/releases/download/v0.10.0/setup_cpp_mac"
...
Download the `setup_cpp.js` file form [here](https://github.com/aminya/setup-cpp/releases/download/v0.10.0/setup_cpp.js), and run it with the available options.
...
RUN wget --no-verbose "https://github.com/aminya/setup-cpp/releases/download/v0.10.0/setup_cpp_linux"
